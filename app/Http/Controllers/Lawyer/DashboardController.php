...
class DashboardController extends Controller
{
    ...
    public function inmates(){
        $inmates = Inmate::all();
        return view('lawyer.inmate.index', compact('inmates'));
    }
    ...
    public function viewInmate($id){
        ...
        $crimes = Crime::all();
        return view('lawyer.inmate.edit', compact('inmate', 'cell','inmate_crimes','cell_blocks','crimes'));
    }

    public function inmateHealthRecords(){
        $health_records = HealthRecord::all();
        return view('lawyer.health_record.index', compact('health_records'));
    }
    ...
    public function viewInmateHealthRecord($id){
        ...
        return view('lawyer.health_record.edit', compact('health_record','inmates', 'diseases'));
    }

    public function inmeateVisits(){
        $visits = Visit::all();
        return view('lawyer.visit.index', compact('visits'));
    }
}
