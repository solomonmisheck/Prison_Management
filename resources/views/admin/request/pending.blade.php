                    ...
                    <tbody>
                        @foreach ($requests as $request)
                            <tr>
                                ...
                                <td>
                                    <a class="btn btn-success btn-sm" href="{{ url('admin/approve-request/' . $request->id) }}">Accept</a> |
                                    <a class="btn btn-danger btn-sm" href="{{ url('admin/reject-request/' . $request->id) }}">Reject</a>
                                </td>
